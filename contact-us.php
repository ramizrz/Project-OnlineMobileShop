...
<head>
    ...
    <title>Conatct-US| Mobile Shop</title>
...
<body>
    		...
    		<div class="row">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>ONLINEMobileShop Ltd.</p>
							<p>513,Sivaji Nagar,Govandi,Mumbai</p>
							<p>Maharashtra INDIA</p>
							<p>Mobile: +91 8850171134</p>
							<p>Land-Line: 0261-222 33 44</p>
							<p>Email: ask2ramiz@gmail.com</p>
	    				</address>
	    				<div class="social-networks">
	    					<h2 class="title text-center"> Connect With Us In Social Networking</h2>
							<ul>
								<li>
									<a href="https://www.facebook.com/ramiz.zamadar.3"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://twitter.com/Ramizra13978237"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
								<li>
								...
								<li>
									<a href="https://www.instagram.com/_ramiz02/?hl=en"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">MOBLIESHOP™<br>
