...
<head>
    ...
    <title>Change Password | Watchshop</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> info@watchshop.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="HomePage.php"><img src="images/home/logo.gif" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-8">
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#"><b>Master</b><i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="discount_detail.php">Discount</a></li>
					...
					<div class="login-form"><!--login form-->
						...
						if(isset($_POST['btnSubmit']))
						{
							...
							elseif($NewPassword==$ConfirmPassword)
							{
								...
								$sql="update tbl_admin set admin_pswd='$NewPassword' where admin_pswd='$Password'";
								//echo $sql;
								mysql_query($sql);
								header("location: index.php?res=1&no=1");
							}
							else
							{
									echo "<h4>";
						...
						<form action="#" method="post">
							...
							<input type="password" placeholder="Old Password" name="txtOldPassword" id="OldPassword" />
							<input type="password" placeholder="New Password" name="txtNewPassword" id="NewPassword" />
							<input type="password" placeholder="Confirm Password" name="txtConfirmPassword" id="ConfirmPassword" />
