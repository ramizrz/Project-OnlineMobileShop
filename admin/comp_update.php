			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						<h2><b>Company Update</b></h2>
						<a href="comp_detail.php">ALL RECORDS</a></br></br>
						...
						<form action="#" method="post">
							...
							<input type="text" placeholder="Company Name" name="txtCompName" id="CompName" value="<?php echo $rows['company']; ?>" />
								
							<button type="submit" name="btnUpdate" class="btn btn-default">Update</button><br>
