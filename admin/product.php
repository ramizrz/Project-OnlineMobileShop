				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						if(isset($_POST['btnSubmit']))
							{
								...
								{
									mysql_query("insert into tbl_product (com_id,prod_name,description,price,quantity,image,image2,image3,image4) values($ComId,'$ProdName','$ProdDesc','$ProdPrice','$ProdQunt','$ProdImgs','$ProdImgs2','$ProdImgs3','$ProdImgs4')");
									//echo $sql;
						...
						<form action="#" method="post">
							...
							<input type="text" placeholder="Product Name" name="txtProdName" id="ProdName" value="<?php if (isset($ProdName)) echo $ProdName; ?>" />
							<input type="text" placeholder="Product Description" rows="7" name="txtProdDesc" id="ProdDesc" value="<?php if (isset($ProdDesc)) echo $ProdDesc; ?>"/>
							<input type="text" placeholder="Price" name="txtProdPrice" id="ProdPrice" value="<?php if (isset($ProdPrice)) echo $ProdPrice; ?>" />
							<input type="text" placeholder="Quantity" name="txtProdQunt" id="ProdQunt" value="<?php if (isset($ProdQunt)) echo $ProdQunt; ?>" />
							
							<input type="hidden" name="MAX_FILE_SIZE" value="2000000"/>
							<label>Main Image</label>
							<input type="file" placeholder="Image" name="ProdImg" id="ProdImgs" size="35" class="btn btn-default"/>
							<label>Image2</label>
